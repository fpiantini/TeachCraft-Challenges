...
# 175:5 	Peony (minecraft:double_plant) 176
# Free-standing Banner (minecraft:standing_banner)
...
# 256 	Iron Shovel (minecraft:iron_shovel)
# 257 	Iron Pickaxe (minecraft:iron_pickaxe)
# 258 	Iron Axe (minecraft:iron_axe)
# 259 	Flint and Steel (minecraft:flint_and_steel)
# 260 	Apple (minecraft:apple)
# 261 	Bow (minecraft:bow)
# 262 	Arrow (minecraft:arrow)
# 263 	Coal (minecraft:coal)
# 263:1 	Charcoal (minecraft:coal)
# 264 	Diamond (minecraft:diamond)
# 265 	Iron Ingot (minecraft:iron_ingot)
# 266 	Gold Ingot (minecraft:gold_ingot)
# 267 	Iron Sword (minecraft:iron_sword)
# 268 	Wooden Sword (minecraft:wooden_sword)
# 269 	Wooden Shovel (minecraft:wooden_shovel)
# 270 	Wooden Pickaxe (minecraft:wooden_pickaxe)
# 271 	Wooden Axe (minecraft:wooden_axe)
# 272 	Stone Sword (minecraft:stone_sword)
# 273 	Stone Shovel (minecraft:stone_shovel)
# 274 	Stone Pickaxe (minecraft:stone_pickaxe)
# 275 	Stone Axe (minecraft:stone_axe)
# 276 	Diamond Sword (minecraft:diamond_sword)
# 277 	Diamond Shovel (minecraft:diamond_shovel)
# 278 	Diamond Pickaxe (minecraft:diamond_pickaxe)
# 279 	Diamond Axe (minecraft:diamond_axe)
# 280 	Stick (minecraft:stick)
# 281 	Bowl (minecraft:bowl)
# 282 	Mushroom Stew (minecraft:mushroom_stew)
# 283 	Golden Sword (minecraft:golden_sword)
# 284 	Golden Shovel (minecraft:golden_shovel)
# 285 	Golden Pickaxe (minecraft:golden_pickaxe)
# 286 	Golden Axe (minecraft:golden_axe)
# 287 	String (minecraft:string)
# 288 	Feather (minecraft:feather)
# 289 	Gunpowder (minecraft:gunpowder)
# 290 	Wooden Hoe (minecraft:wooden_hoe)
# 291 	Stone Hoe (minecraft:stone_hoe)
# 292 	Iron Hoe (minecraft:iron_hoe)
# 293 	Diamond Hoe (minecraft:diamond_hoe)
# 294 	Golden Hoe (minecraft:golden_hoe)
# 295 	Wheat Seeds (minecraft:wheat_seeds)
# 296 	Wheat (minecraft:wheat)
# 297 	Bread (minecraft:bread)
# 298 	Leather Helmet (minecraft:leather_helmet)
# 299 	Leather Tunic (minecraft:leather_chestplate)
# 300 	Leather Pants (minecraft:leather_leggings)
# 301 	Leather Boots (minecraft:leather_boots)
# 302 	Chainmail Helmet (minecraft:chainmail_helmet)
# 303 	Chainmail Chestplate (minecraft:chainmail_chestplate)
# 304 	Chainmail Leggings (minecraft:chainmail_leggings)
# 305 	Chainmail Boots (minecraft:chainmail_boots)
# 306 	Iron Helmet (minecraft:iron_helmet)
# 307 	Iron Chestplate (minecraft:iron_chestplate)
# 308 	Iron Leggings (minecraft:iron_leggings)
# 309 	Iron Boots (minecraft:iron_boots)
# 310 	Diamond Helmet (minecraft:diamond_helmet)
# 311 	Diamond Chestplate (minecraft:diamond_chestplate)
# 312 	Diamond Leggings (minecraft:diamond_leggings)
# 313 	Diamond Boots (minecraft:diamond_boots)
# 314 	Golden Helmet (minecraft:golden_helmet)
# 315 	Golden Chestplate (minecraft:golden_chestplate)
# 316 	Golden Leggings (minecraft:golden_leggings)
# 317 	Golden Boots (minecraft:golden_boots)
# 318 	Flint (minecraft:flint)
# 319 	Raw Porkchop (minecraft:porkchop)
# 320 	Cooked Porkchop (minecraft:cooked_porkchop)
# 321 	Painting (minecraft:painting)
# 322 	Golden Apple (minecraft:golden_apple)
# 322:1 	Enchanted Golden Apple (minecraft:golden_apple)
# 323 	Sign (minecraft:sign)
# 324 	Oak Door (minecraft:wooden_door)
# 325 	Bucket (minecraft:bucket)
# 326 	Water Bucket (minecraft:water_bucket)
# 327 	Lava Bucket (minecraft:lava_bucket)
# 328 	Minecart (minecraft:minecart)
# 329 	Saddle (minecraft:saddle)
# 330 	Iron Door (minecraft:iron_door)
# 331 	Redstone (minecraft:redstone)
# 332 	Snowball (minecraft:snowball)
# 333 	Oak Boat (minecraft:boat)
# 334 	Leather (minecraft:leather)
# 335 	Milk Bucket (minecraft:milk_bucket)
# 336 	Brick (minecraft:brick)
# 337 	Clay (minecraft:clay_ball)
# 338 	Sugar Canes (minecraft:reeds)
# 339 	Paper (minecraft:paper)
# 340 	Book (minecraft:book)
# 341 	Slimeball (minecraft:slime_ball)
# 342 	Minecart with Chest (minecraft:chest_minecart)
# 343 	Minecart with Furnace (minecraft:furnace_minecart)
# 344 	Egg (minecraft:egg)
# 345 	Compass (minecraft:compass)
# 346 	Fishing Rod (minecraft:fishing_rod)
# 347 	Clock (minecraft:clock)
# 348 	Glowstone Dust (minecraft:glowstone_dust)
# 349 	Raw Fish (minecraft:fish)
# 349:1 	Raw Salmon (minecraft:fish)
# 349:2 	Clownfish (minecraft:fish)
# 349:3 	Pufferfish (minecraft:fish)
# 350 	Cooked Fish (minecraft:cooked_fish)
# 350:1 	Cooked Salmon (minecraft:cooked_fish)
# 351 	Ink Sack (minecraft:dye)
# 351:1 	Rose Red (minecraft:dye)
# # 351:2 	Cactus Green (minecraft:dye)
# 351:3 	Coco Beans (minecraft:dye)
# 351:4 	Lapis Lazuli (minecraft:dye)
# 351:5 	Purple Dye (minecraft:dye)
# 351:6 	Cyan Dye (minecraft:dye)
# 351:7 	Light Gray Dye (minecraft:dye)
# 351:8 	Gray Dye (minecraft:dye)
# 351:9 	Pink Dye (minecraft:dye)
# 351:10 	Lime Dye (minecraft:dye)
# 351:11 	Dandelion Yellow (minecraft:dye)
# 351:12 	Light Blue Dye (minecraft:dye)
# 351:13 	Magenta Dye (minecraft:dye)
# 351:14 	Orange Dye (minecraft:dye)
# 351:15 	Bone Meal (minecraft:dye)
# 352 	Bone (minecraft:bone)
# 353 	Sugar (minecraft:sugar)
# 354 	Cake (minecraft:cake)
# 355 	Bed (minecraft:bed)
# 356 	Redstone Repeater (minecraft:repeater)
# 357 	Cookie (minecraft:cookie)
# 358 	Map (minecraft:filled_map)
# 359 	Shears (minecraft:shears)
# 360 	Melon (minecraft:melon)
# 361 	Pumpkin Seeds (minecraft:pumpkin_seeds)
# 362 	Melon Seeds (minecraft:melon_seeds)
# 363 	Raw Beef (minecraft:beef)
# 364 	Steak (minecraft:cooked_beef)
# 365 	Raw Chicken (minecraft:chicken)
# 366 	Cooked Chicken (minecraft:cooked_chicken)
# 367 	Rotten Flesh (minecraft:rotten_flesh)
# 368 	Ender Pearl (minecraft:ender_pearl)
# 369 	Blaze Rod (minecraft:blaze_rod)
# 370 	Ghast Tear (minecraft:ghast_tear)
# 371 	Gold Nugget (minecraft:gold_nugget)
# 372 	Nether Wart (minecraft:nether_wart)
# 373 	Potion (minecraft:potion)
# 374 	Glass Bottle (minecraft:glass_bottle)
# 375 	Spider Eye (minecraft:spider_eye)
# 376 	Fermented Spider Eye (minecraft:fermented_spider_eye)
# 377 	Blaze Powder (minecraft:blaze_powder)
# 378 	Magma Cream (minecraft:magma_cream)
# 379 	Brewing Stand (minecraft:brewing_stand)
# 380 	Cauldron (minecraft:cauldron)
# 381 	Eye of Ender (minecraft:ender_eye)
# 382 	Glistering Melon (minecraft:speckled_melon)
# 383:50 	Spawn Creeper (minecraft:spawn_egg)
# 383:51 	Spawn Skeleton (minecraft:spawn_egg)
# 383:52 	Spawn Spider (minecraft:spawn_egg)
# 383:54 	Spawn Zombie (minecraft:spawn_egg)
# 383:55 	Spawn Slime (minecraft:spawn_egg)
# 383:56 	Spawn Ghast (minecraft:spawn_egg)
# 383:57 	Spawn Pigman (minecraft:spawn_egg)
# 383:58 	Spawn Enderman (minecraft:spawn_egg)
# 383:59 	Spawn Cave Spider (minecraft:spawn_egg)
# 383:60 	Spawn Silverfish (minecraft:spawn_egg)
# 383:61 	Spawn Blaze (minecraft:spawn_egg)
# 383:62 	Spawn Magma Cube (minecraft:spawn_egg)
# 383:65 	Spawn Bat (minecraft:spawn_egg)
# 383:66 	Spawn Witch (minecraft:spawn_egg)
# 383:67 	Spawn Endermite (minecraft:spawn_egg)
# 383:68 	Spawn Guardian (minecraft:spawn_egg)
# 383:69 	Spawn Shulker (minecraft:spawn_egg)
# 383:90 	Spawn Pig (minecraft:spawn_egg)
# 383:91 	Spawn Sheep (minecraft:spawn_egg)
# 383:92 	Spawn Cow (minecraft:spawn_egg)
# 383:93 	Spawn Chicken (minecraft:spawn_egg)
# 383:94 	Spawn Squid (minecraft:spawn_egg)
# 383:95 	Spawn Wolf (minecraft:spawn_egg)
# 383:96 	Spawn Mooshroom (minecraft:spawn_egg)
# 383:98 	Spawn Ocelot (minecraft:spawn_egg)
# 383:100 	Spawn Horse (minecraft:spawn_egg)
# 383:101 	Spawn Rabbit (minecraft:spawn_egg)
# 383:120 	Spawn Villager (minecraft:spawn_egg)
# 384 	Bottle o' Enchanting (minecraft:experience_bottle)
# 385 	Fire Charge (minecraft:fire_charge)
# 386 	Book and Quill (minecraft:writable_book)
# 387 	Written Book (minecraft:written_book)
# 388 	Emerald (minecraft:emerald)
# 389 	Item Frame (minecraft:item_frame)
# 390 	Flower Pot (minecraft:flower_pot)
# 391 	Carrot (minecraft:carrot)
# 392 	Potato (minecraft:potato)
# 393 	Baked Potato (minecraft:baked_potato)
# 394 	Poisonous Potato (minecraft:poisonous_potato)
# 395 	Empty Map (minecraft:map)
# 396 	Golden Carrot (minecraft:golden_carrot)
# 397 	Mob Head (Skeleton) (minecraft:skull)
# 397:1 	Mob Head (Wither Skeleton) (minecraft:skull)
# 397:2 	Mob Head (Zombie) (minecraft:skull)
# 397:3 	Mob Head (Human) (minecraft:skull)
# 397:4 	Mob Head (Creeper) (minecraft:skull)
# 397:5 	Mob Head (Dragon) (minecraft:skull)
# 398 	Carrot on a Stick (minecraft:carrot_on_a_stick)
# 399 	Nether Star (minecraft:nether_star)
# 400 	Pumpkin Pie (minecraft:pumpkin_pie)
# 401 	Firework Rocket (minecraft:fireworks)
# 402 	Firework Star (minecraft:firework_charge)
# 403 	Enchanted Book (minecraft:enchanted_book)
# 404 	Redstone Comparator (minecraft:comparator)
# 405 	Nether Brick (minecraft:netherbrick)
# 406 	Nether Quartz (minecraft:quartz)
# 407 	Minecart with TNT (minecraft:tnt_minecart)
# 408 	Minecart with Hopper (minecraft:hopper_minecart)
# 409 	Prismarine Shard (minecraft:prismarine_shard)
# 410 	Prismarine Crystals (minecraft:prismarine_crystals)
# 411 	Raw Rabbit (minecraft:rabbit)
# 412 	Cooked Rabbit (minecraft:cooked_rabbit)
# 413 	Rabbit Stew (minecraft:rabbit_stew)
# 414 	Rabbit's Foot (minecraft:rabbit_foot)
# 415 	Rabbit Hide (minecraft:rabbit_hide)
# 416 	Armor Stand (minecraft:armor_stand)
# 417 	Iron Horse Armor (minecraft:iron_horse_armor)
# 418 	Golden Horse Armor (minecraft:golden_horse_armor)
# 419 	Diamond Horse Armor (minecraft:diamond_horse_armor)
# 420 	Lead (minecraft:lead)
# 421 	Name Tag (minecraft:name_tag)
# 422 	Minecart with Command Block (minecraft:command_block_minecart)
# 423 	Raw Mutton (minecraft:mutton)
# 424 	Cooked Mutton (minecraft:cooked_mutton)
# 425 	Banner (minecraft:banner)
# 427 	Spruce Door (minecraft:spruce_door)
# 428 	Birch Door (minecraft:birch_door)
# 429 	Jungle Door (minecraft:jungle_door)
# 430 	Acacia Door (minecraft:acacia_door)
# 431 	Dark Oak Door (minecraft:dark_oak_door)
# 432 	Chorus Fruit (minecraft:chorus_fruit)
# 433 	Popped Chorus Fruit (minecraft:popped_chorus_fruit)
# 434 	Beetroot (minecraft:beetroot)
# 435 	Beetroot Seeds (minecraft:beetroot_seeds)
# 436 	Beetroot Soup (minecraft:beetroot_soup)
# 437 	Dragon's Breath (minecraft:dragon_breath)
# 438 	Splash Potion (minecraft:splash_potion)
# 439 	Spectral Arrow (minecraft:spectral_arrow)
# 440 	Tipped Arrow (minecraft:tipped_arrow)
# 441 	Lingering Potion (minecraft:lingering_potion)
# 442 	Shield (minecraft:shield)
# 443 	Elytra (minecraft:elytra)
# 444 	Spruce Boat (minecraft:spruce_boat)
# 445 	Birch Boat (minecraft:birch_boat)
# 446 	Jungle Boat (minecraft:jungle_boat)
# 447 	Acacia Boat (minecraft:acacia_boat)
# 448 	Dark Oak Boat (minecraft:dark_oak_boat)
# 2256 	13 Disc (minecraft:record_13)
# 2257 	Cat Disc (minecraft:record_cat)
# 2258 	Blocks Disc (minecraft:record_blocks)
# 2259 	Chirp Disc (minecraft:record_chirp)
# 2260 	Far Disc (minecraft:record_far)
# 2261 	Mall Disc (minecraft:record_mall)
# 2262 	Mellohi Disc (minecraft:record_mellohi)
# 2263 	Stal Disc (minecraft:record_stal)
# 2264 	Strad Disc (minecraft:record_strad)
# 2265 	Ward Disc (minecraft:record_ward)
# 2266 	11 Disc (minecraft:record_11)
# 2267 	Wait Disc (minecraft:record_wait)
